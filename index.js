...
Module['FS_createPath']("/res", "sfx", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/img/title_text.png", "start": 0, "end": 1161}, {"filename": "/res/music/no_stopping_now.ogg", "start": 1161, "end": 2774037, "audio": 1}, {"filename": "/res/music/title_theme.ogg", "start": 2774037, "end": 5664122, "audio": 1}, {"filename": "/res/sfx/click.ogg", "start": 5664122, "end": 5676204, "audio": 1}, {"filename": "/res/sfx/grab.ogg", "start": 5676204, "end": 5698723, "audio": 1}], "remote_package_size": 5698723});

  })();

// end include: /tmp/tmpoiilsc3i.js
// include: /tmp/tmpxag452l1.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpxag452l1.js
// include: /tmp/tmp64knjbqt.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp64knjbqt.js
