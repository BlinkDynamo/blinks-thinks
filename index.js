...
// end include: /tmp/tmp8puo5jsu.js
// include: /tmp/tmp_jfcjkf8.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp_jfcjkf8.js
// include: /tmp/tmp79llqp0w.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp79llqp0w.js
...
var ASM_CONSTS = {
  131926: () => { if (document.fullscreenElement) return 1; },  
 131972: () => { return Module.canvas.width; },  
 132004: () => { return parseInt(Module.canvas.style.width); },  
 132052: () => { document.exitFullscreen(); },  
 132079: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 132152: () => { if (document.fullscreenElement) return 1; },  
 132198: () => { return Module.canvas.width; },  
 132230: () => { return screen.width; },  
 132255: () => { document.exitFullscreen(); },  
 132282: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 132415: () => { return window.innerWidth; },  
 132441: () => { return window.innerHeight; },  
 132468: () => { if (document.fullscreenElement) return 1; },  
 132514: () => { return Module.canvas.width; },  
 132546: () => { return parseInt(Module.canvas.style.width); },  
 132594: () => { if (document.fullscreenElement) return 1; },  
 132640: () => { return Module.canvas.width; },  
 132672: () => { return screen.width; },  
 132697: () => { return window.innerWidth; },  
 132723: () => { return window.innerHeight; },  
 132750: () => { if (document.fullscreenElement) return 1; },  
 132796: () => { return Module.canvas.width; },  
 132828: () => { return screen.width; },  
 132853: () => { document.exitFullscreen(); },  
 132880: () => { if (document.fullscreenElement) return 1; },  
 132926: () => { return Module.canvas.width; },  
 132958: () => { return parseInt(Module.canvas.style.width); },  
 133006: () => { document.exitFullscreen(); },  
 133033: ($0) => { Module.canvas.style.opacity = $0; },  
 133071: () => { return screen.width; },  
 133096: () => { return screen.height; },  
 133122: () => { return window.screenX; },  
 133149: () => { return window.screenY; },  
 133176: () => { return window.devicePixelRatio; },  
 133212: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 133265: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 133316: () => { Module.canvas.style.cursor = 'none'; },  
 133353: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 133609: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 133660: () => { if (document.fullscreenElement) return 1; },  
 133706: () => { return window.innerWidth; },  
 133732: () => { return window.innerHeight; },  
 133759: () => { if (document.pointerLockElement) return 1; },  
