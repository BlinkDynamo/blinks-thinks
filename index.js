...
// include: /tmp/tmpjutc5p2s.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/out/web/index.data';
...
Module['FS_createPath']("/", "audio", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/out/web/index.data');

      };
      Module['addRunDependency']('datafile_build/out/web/index.data');
    ...
    loadPackage({"files": [{"filename": "/audio/title_theme.ogg", "start": 0, "end": 2307642, "audio": 1}], "remote_package_size": 2307642});

  })();

// end include: /tmp/tmpjutc5p2s.js
// include: /tmp/tmp6qarq9wq.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp6qarq9wq.js
// include: /tmp/tmp35gmoysp.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp35gmoysp.js
...
var ASM_CONSTS = {
  127280: () => { if (document.fullscreenElement) return 1; },  
 127326: () => { return Module.canvas.width; },  
 127358: () => { return parseInt(Module.canvas.style.width); },  
 127406: () => { document.exitFullscreen(); },  
 127433: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 127506: () => { if (document.fullscreenElement) return 1; },  
 127552: () => { return Module.canvas.width; },  
 127584: () => { return screen.width; },  
 127609: () => { document.exitFullscreen(); },  
 127636: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 127769: () => { return window.innerWidth; },  
 127795: () => { return window.innerHeight; },  
 127822: () => { if (document.fullscreenElement) return 1; },  
 127868: () => { return Module.canvas.width; },  
 127900: () => { return parseInt(Module.canvas.style.width); },  
 127948: () => { if (document.fullscreenElement) return 1; },  
 127994: () => { return Module.canvas.width; },  
