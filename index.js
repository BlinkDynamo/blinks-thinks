...
// end include: /tmp/tmpl0it4kpu.js
// include: /tmp/tmpg_b6vc6m.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpg_b6vc6m.js
// include: /tmp/tmpq7ulnibt.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpq7ulnibt.js
...
var ASM_CONSTS = {
  140808: () => { if (document.fullscreenElement) return 1; },  
 140854: () => { return Module.canvas.width; },  
 140886: () => { return parseInt(Module.canvas.style.width); },  
 140934: () => { document.exitFullscreen(); },  
 140961: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 141034: () => { if (document.fullscreenElement) return 1; },  
 141080: () => { return Module.canvas.width; },  
 141112: () => { return screen.width; },  
 141137: () => { document.exitFullscreen(); },  
 141164: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 141297: () => { return window.innerWidth; },  
 141323: () => { return window.innerHeight; },  
 ...
 148572: ($0) => { miniaudio.untrack_device_by_index($0); },  
 148615: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 148740: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
